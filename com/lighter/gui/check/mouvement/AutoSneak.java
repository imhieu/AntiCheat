...
public class AutoSneak extends Gui
{
    private final Map<Integer, Check.CheckType> checksById;
    
    public AutoSneak() {
        super(String.valueOf(new StringBuilder().append(ChatColor.RED).append("AutoSneak")), 18);
        ...
        for (final Check.CheckType checkType : Check.CheckType.values()) {
            if (checkType.getName().contains("AutoSneak")) {
