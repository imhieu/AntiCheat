...
public class PingSpoof extends Gui
{
    ...
    public PingSpoof() {
        super(String.valueOf(new StringBuilder().append(ChatColor.RED).append("PingSpoof")), 18);
        ...
        for (final Check.CheckType checkType : Check.CheckType.values()) {
            if (checkType.getName().contains("PingSpoof")) {
