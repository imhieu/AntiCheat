...
public class InvalidPos extends Gui
{
    private final Map<Integer, Check.CheckType> checksById;
    
    public InvalidPos() {
        super(String.valueOf(new StringBuilder().append(ChatColor.RED).append("InvalidPos")), 18);
        ...
        for (final Check.CheckType checkType : Check.CheckType.values()) {
            if (checkType.getName().contains("InvalidPos")) {
