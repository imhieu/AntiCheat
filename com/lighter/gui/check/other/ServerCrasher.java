package com.lighter.gui.check.other;
...
public class ServerCrasher extends Gui
{
    ...
    public ServerCrasher() {
        super(String.valueOf(new StringBuilder().append(ChatColor.RED).append("ServerCrasher")), 18);
        ...
        for (final Check.CheckType checkType : Check.CheckType.values()) {
            if (checkType.getName().contains("ServerCrasher")) {
