...
public class InvalidInteract extends Gui
{
    ...
    public InvalidInteract() {
        super(String.valueOf(new StringBuilder().append(ChatColor.RED).append("InvalidInteract")), 18);
        ...
        for (final Check.CheckType checkType : Check.CheckType.values()) {
            if (checkType.getName().contains("InvalidInteract")) {
