...
public class Criticals extends Gui
{
    ...
    public Criticals() {
        super(String.valueOf(new StringBuilder().append(ChatColor.RED).append("Criticals")), 18);
        ...
        for (final Check.CheckType checkType : Check.CheckType.values()) {
            if (checkType.getName().contains("Criticals")) {
