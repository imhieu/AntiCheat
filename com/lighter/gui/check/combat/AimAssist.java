...
public class AimAssist extends Gui
{
    ...
    public AimAssist() {
        super(String.valueOf(new StringBuilder().append(ChatColor.RED).append("AimAssist")), 36);
        ...
        for (final Check.CheckType checkType : Check.CheckType.values()) {
            if (checkType.getName().contains("AimAssist")) {
