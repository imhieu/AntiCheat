...
public class InvalidInventory extends Gui
{
    private final Map<Integer, Check.CheckType> checksById;
    
    public InvalidInventory() {
        super(String.valueOf(new StringBuilder().append(ChatColor.RED).append("InvalidInventory")), 18);
        ...
        for (final Check.CheckType checkType : Check.CheckType.values()) {
            if (checkType.getName().contains("InvalidInventory")) {
