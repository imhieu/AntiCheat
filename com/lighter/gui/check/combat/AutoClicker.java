...
public class AutoClicker extends Gui
{
    private final Map<Integer, Check.CheckType> checksById;
    
    public AutoClicker() {
        super(String.valueOf(new StringBuilder().append(ChatColor.RED).append("AutoClicker")), 36);
        ...
        for (final Check.CheckType checkType : Check.CheckType.values()) {
            if (checkType.getName().contains("AutoClicker")) {
