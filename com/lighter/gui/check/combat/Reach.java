...
public class Reach extends Gui
{
    private final Map<Integer, Check.CheckType> checksById;
    
    public Reach() {
        super(String.valueOf(new StringBuilder().append(ChatColor.RED).append("Reach")), 18);
        ...
        for (final Check.CheckType checkType : Check.CheckType.values()) {
            if (checkType.getName().contains("Reach") || checkType.getName().contains("Bad Range")) {
